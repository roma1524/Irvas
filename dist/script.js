...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'after_click');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decor_cont', 'after_click');
...
var modals = function modals() {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // showModalTimeout('.popup', 60000);
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (event) {
    ...
    if (target.classList.contains(tabSelector.slice(1)) || target.parentNode.classList.contains(tabSelector.slice(1))) {
      tab.forEach(function (item, i) {
        if (target && item == target || target.parentNode == item) {
          hideTabContent();
          showTabContent(i);
        }
      });
